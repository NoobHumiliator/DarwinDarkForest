...
LinkLuaModifier( "modifier_undead_tusk_bone_ball", "creature_ability/modifier/modifier_undead_tusk_bone_ball", LUA_MODIFIER_MOTION_HORIZONTAL )
...
function undead_tusk_bone_ball:EndBoneBall( bHitTarget )
	if IsServer() then
		...
		if self:GetCaster() ~= nil then
			...
			self:GetCaster():RemoveModifierByName( "modifier_undead_tusk_bone_ball" )
